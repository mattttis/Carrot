...
struct FoodData {
    ...
    static var household: [String] {
        ...
        // Dutch
        case "nl": return ["axe", "deo", "deodorant", "axe deo", "zeep", "wasmiddel", "keukenpapier", "keukenrol", "keukenrollen", "toiletrollen", "toiletreiniger", "doekjes", "afvalzakken", "tissues", "zakdoekjes", "tandpasta", "tandenborstel", "zonnebrand", "handgel", "bekers", "bekertjes", "aluminiumfolie", "bakpapier", "zonnebrand", "zeep", "muggenspul", "muggenspray", "shampoo", "conditioner", "douchegel", "axe douchegel", "wax", "gel", "vuilniszakken", "scheermesjes", "scheerschuim", "waxinelichtjes", "deo 0%"]
