...
struct FoodData {
    ...
    static let bakery: [String] = ["bagels", "bread", "donuts", "cake", "cookies", "croutons", "dinner rolls", "hamburger buns", "hot dog buns", "muffins", "pastries", "pie", "pita bread", "tortillas", "corn tortillas", "flour tortillas", "croissant", "bread roll"]
